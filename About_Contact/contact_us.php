    ...
    <body style="background: #f5f5f5">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li class="active"><a href="../Catalog/catalog.php">Shop</a></li>
        ...
        <div class="content">
            <div class="page-header">
                <h2>Contact Us</h2>
                <p>We love to hear from our customers! <br/>
                Whether you have questions about our products, need assistance with an
                order, or just want to share your feedback, we're here to help. <br/>
                Thank you for choosing Urban Soles!</p>
            </div>

            <div class="container-fluid">
                <div class="row">
                    <div class="page-info col-md-6 pr-md-5">
                        <div class="contactInfo">
                            <div class="box">
                                <div class="icon"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
                                <div class="text">
                                    <h3>Address</h3>
                                    <p>1234 Central Avenue, Brgy. New Era, Quezon City</p>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="text">
                                    <h3>Email</h3>
                                    <p>urban.soles@sample.com</p>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div class="page-form col-md-6 pr-md-5">
                        <form action="#">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" cols="30" rows="7" placeholder="Comments" name="comments" required></textarea>
                            </div>
